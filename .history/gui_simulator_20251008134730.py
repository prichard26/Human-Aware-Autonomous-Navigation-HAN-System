...
class HAANGUI:
    ...
    def setup_ui(self):
        ...
        # Configure grid weights for 2-column layout
        self.root.columnconfigure(0, weight=1)
        self.root.rowconfigure(0, weight=1)
        main_frame.columnconfigure(1, weight=3)  # Visualization gets more space
        ...
        # Left panel - Controls (with status indicators and log)
        self.setup_control_panel(main_frame)
        
        # Right panel - Visualization
        self.setup_visualization_panel(main_frame)
        
        # Right panel setup (currently unused)
    ...
    def setup_control_panel(self, parent):
        ...
        ttk.Button(image_frame, text="Browse", command=self.browse_image).grid(row=0, column=1, padx=(0, 5))
        ttk.Button(image_frame, text="Clear", command=self.clear_image).grid(row=0, column=2)
        ...
        self.start_random_button = ttk.Button(button_frame, text="🎲 Random Only", 
                                            command=self.start_random_simulation)
        self.start_random_button.grid(row=0, column=1, padx=5)
        ...
        # Log text area in controls panel
        log_frame = ttk.LabelFrame(control_frame, text="📝 System Log", padding="5")
    ...
    def setup_visualization_panel(self, parent):
        ...
        viz_frame.grid(row=1, column=1, sticky=(tk.W, tk.E, tk.N, tk.S), padx=(10, 0))
    ...
    def setup_status_panel(self, parent):
        """Setup the right panel (currently unused)."""
        # Right panel is now empty since log moved to left panel
        pass
    ...
    def clear_image(self):
        ...
        self.log("🗑️ Image cleared - will use random obstacles")
    
    def start_simulation(self):
        """Start the simulation with image input."""
    ...
    def start_random_simulation(self):
        ...
        # Clear image path to use random obstacles
        self.current_image_path.set("")
        self._start_simulation_common()
    
    def _start_simulation_common(self):
        """Common simulation start logic."""
        
        # Update UI state
        self.is_simulation_running = True
        self.start_button.config(state='disabled')
        self.start_random_button.config(state='disabled')
    ...
    def _run_simulation_thread(self):
        ...
        try:
            ...
            # Update goal position and simulation parameters from GUI
        ...
        try:
            ...
            if self.current_frame < len(robot_positions):
                ...
                if distance_to_goal <= 15:
                    ...
                    self.ax.text(goal[0], goal[1] + 20, "🎯 GOAL REACHED!", 
    ...
    def stop_simulation(self):
        ...
        self.start_random_button.config(state='normal')
