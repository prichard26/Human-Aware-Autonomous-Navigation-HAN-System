...
class HAANGUI:
    ...
    def _run_simulation_thread(self):
        ...
        try:
            ...
            self.haan_system.config['simulation_time'] = self.simulation_config['simulation_time'].get()
            self.haan_system.config['robot_speed'] = self.simulation_config['robot_speed'].get() * 0.3  # Apply scale
